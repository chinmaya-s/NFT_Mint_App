...
// File contracts/LimitedMintERC721.sol
...
contract LimitedMintERC721 is ERC721, Ownable {
    ...
    constructor(
        ...
        ERC721(collectionName, collectionSymbol) Ownable(_msgSender())
    {
    ...
    function _mintToken(
        ...
        require(_mintCount[_msgSender()] < 5, "Max minting capacity reached");
        require(msg.value >= 0.1 ether, "Please pay at least 0.1 ETH to mint");
        (bool sent, bytes memory data) = owner().call{value: msg.value}("");
        require(sent, "Failed to send Ether");
        _mintCount[_msgSender()] = _mintCount[_msgSender()]+1;
        _currTokenId = _currTokenId+1;
        _safeMint(to, _currTokenId);
    }
    ...
    function mintCount(address user) public view returns (uint8){
